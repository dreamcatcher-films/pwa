...
export const UserGroupIcon: React.FC<{className?: string}> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962A3.75 3.75 0 0112 15v-2.25A3.75 3.75 0 0115.75 9h.008v.008h-.008A3.75 3.75 0 0112 12.75v-2.25A3.75 3.75 0 019.75 7.5h.008v.008h-.008A3.75 3.75 0 016 11.25v2.25A3.75 3.75 0 018.25 18-3.75 3.75 0 016 15.75v-2.25A3.75 3.75 0 019.75 9.75" />
    </svg>
);
